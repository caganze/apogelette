...
def lnprior(model):
    ...
    """
    teff, logg,  fe_h, rv, vsni=model.theta  #parameters should be arranged in this manner
...
def run_MCMC(**kwargs):
    ...
    #visualization 
    param_names=['teff', 'logg',  'fe_h', 'rv', 'vsni']
    #std keys
    param_er_names=['teff_er', 'logg_er',  'fe_h_er', 'rv_er', 'vsni_er']
